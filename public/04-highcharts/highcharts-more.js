...
(function (e) {
  'object' === typeof module && module.exports
    ...
    ? define('highcharts/highcharts-more', ['highcharts'], function (z) {
        e(z);
        e.Highcharts = z;
        return e;
      })
    ...
    function (e, d, h, c, a, t) {
      ...
      a = (function () {
        ...
        b.prototype.render = function () {
          ...
          this.updateCenter();
          if (a)
            for (a = q(a), b = Math.max(a.length, this.background.length || 0), k = 0; k < b; k++)
              a[k] && this.axis
                ? this.renderBackground(x(this.defaultBackgroundOptions, a[k]), k)
                : this.background[k] &&
                  ((this.background[k] = this.background[k].destroy()),
                  this.background.splice(k, 1));
        };
        b.prototype.renderBackground = function (b, a) {
          ...
          this.background[a] ||
            ((this.background[a] = this.chart.renderer.path().add(this.group)), (k = 'attr'));
      ...
      e.prototype.getHoverPane = function (b) {
        ...
        b &&
          a.pane.forEach(function (p) {
            var q = b.chartX - a.plotLeft,
              v = b.chartY - a.plotTop;
      ...
      l(c, 'beforeGetHoverData', function (a) {
        var k = this.chart;
        k.polar
          ? ((k.hoverPane = k.getHoverPane(a)),
            (a.filter = function (q) {
              return (
                q.visible &&
                !(!a.shared && q.directTouch) &&
                b(q.options.enableMouseTracking, !0) &&
                (!k.hoverPane || q.xAxis.pane === k.hoverPane)
              );
            }))
          : (k.hoverPane = void 0);
      });
      l(c, 'afterGetHoverData', function (b) {
        ...
        b.hoverPoint &&
          ...
          b.hoverPoint.plotY &&
          a.hoverPane &&
          !m(b.hoverPoint.plotX, b.hoverPoint.plotY, a.hoverPane.center) &&
          (b.hoverPoint = void 0);
      });
      d.Pane = a;
      return d.Pane;
      ...
      (function (c) {
        function d() {
          this.autoConnect =
            ...
            l(this.endAngleRad - this.startAngleRad) === l(2 * Math.PI);
        ...
        function y() {
          ...
          return function () {
            if (
              ...
              f.tickPositions &&
              f.options.labels &&
              !0 !== f.options.labels.allowOverlap
            )
              return f.tickPositions
                .map(function (g) {
          ...
          if (this.isCircular) {
            if (r(u))
              f.point &&
                ((a = f.point.shapeArgs || {}),
                a.start &&
                  (u = this.chart.inverted ? this.translate(f.point.rectPlotY, !0) : f.point.x));
            else {
              var a = f.chartX || 0;
              var w = f.chartY || 0;
            ...
            r(u) || ((a = f.chartX), (w = f.chartY)),
              r(a) &&
                r(w) &&
                ((b = n[1] + this.chart.plotTop),
                (u = this.translate(
                  Math.min(Math.sqrt(Math.pow(a - g, 2) + Math.pow(w - b, 2)), n[2] / 2) - n[3] / 2,
                  !0
                )));
          return [u, a || 0, w || 0];
        }
        function f(f, g, b) {
          ...
          var u = this.chart,
            n = this.left || 0,
            a = this.top || 0,
            w = k(g, f[2] / 2 - this.offset);
          'undefined' === typeof b && (b = this.horiz ? 0 : this.center && -this.center[3] / 2);
          b && (w += b);
          this.isCircular || 'undefined' !== typeof g
            ? ((g = this.chart.renderer.symbols.arc(n + f[0], a + f[1], w, w, {
              ...
              (g.xBounds = [n + f[0]]),
              (g.yBounds = [a + f[1] - w]))
            : ((g = this.postTranslate(this.angleRad, w)),
              (g = [
                ['M', this.center[0] + u.plotLeft, this.center[1] + u.plotTop],
                ['L', g.x, g.y],
              ]));
          return g;
        }
        ...
        function n(f, g, b) {
          var u = this.chart,
            ...
            y = /%$/,
            F = this.isCircular,
            c = k(n(b.outerRadius), A),
            d = n(b.innerRadius);
          n = k(n(b.thickness), 10);
          if ('polygon' === this.options.gridLineInterpolation)
            q = this.getPlotLinePath({ value: f }).concat(
              this.getPlotLinePath({ value: g, reverse: !0 })
            );
          else {
            ...
            g = this.translate(g);
            F || ((c = f || 0), (d = g || 0));
            if ('circle' !== b.shape && F) (b = w + (f || 0)), (w += g || 0);
            else {
              b = -Math.PI / 2;
              w = 1.5 * Math.PI;
              var l = !0;
            ...
            F &&
              ((F = (w + b) / 2),
              (p = p + a[0] + (a[2] / 2) * Math.cos(F)),
              (q.xBounds = F > -Math.PI / 2 && F < Math.PI / 2 ? [p, u.plotWidth] : [0, p]),
              (q.yBounds = [v + a[1] + (a[2] / 2) * Math.sin(F)]),
              (q.yBounds[0] += (F > -Math.PI && 0 > F) || F > Math.PI ? -10 : 10));
          }
          return q;
        }
        function w(f) {
          var g = this,
            ...
            u = n.inverted,
            a = f.reverse,
            w = this.pane.options.background
          ...
          if (this.isCircular)
            (c = Math.sqrt(Math.pow(h - k, 2) + Math.pow(l - v, 2))),
              (a = 'string' === typeof q ? p(q, 1) : q / c),
              (n = 'string' === typeof A ? p(A, 1) : A / c),
              b && w && ((w /= c), a < w && (a = w), n < w && (n = w)),
              (b = [
                ['M', k + a * (h - k), v - a * (v - l)],
                ['L', h - (1 - n) * (h - k), l + (1 - n) * (v - l)],
              ]);
          else if (
            ((c = this.translate(c)) && (0 > c || c > F) && (c = 0),
            'circle' === this.options.gridLineInterpolation)
          )
            b = this.getLinePath(0, c, w);
          else if (
            ((b = []),
            n[u ? 'yAxis' : 'xAxis'].forEach(function (f) {
              f.pane === g.pane && (d = f);
            }),
            d)
          )
            for (
              ...
              (w = d.getPosition(k[v], c)), b.push(v ? ['L', w.x, w.y] : ['M', w.x, w.y]);
          return b;
        }
        function A(f, g) {
          f = this.translate(f);
          return this.postTranslate(
            this.isCircular ? f : this.angleRad,
            k(this.isCircular ? g : 0 > f ? 0 : f, this.center[2] / 2) - this.offset
          );
        }
        function F() {
          var f = this.center,
          ...
          return {
            ...
            y: g.plotTop + f[1] - { high: 0.5, middle: 0.25, low: 0 }[b.align] * f[2] + (b.y || 0),
          };
        }
        function J(b) {
        ...
        function B() {
          ...
          (f.angular && this.isXAxis) ||
            !b ||
            (!f.angular && !f.polar) ||
            ((this.angleRad = ((g.angle || 0) * Math.PI) / 180),
            (this.startAngleRad = ((n.startAngle - 90) * Math.PI) / 180),
            (this.endAngleRad = ((k(n.endAngle, n.startAngle + 360) - 90) * Math.PI) / 180),
        ...
        function K(f) {
          ...
          var p;
          if ('colorAxis' === w) this.isRadial = !1;
          else {
            if (n) {
              if (
                (k
              ...
              u &&
                (J(this),
                (this.defaultPolarOptions = (p = this.horiz)
                  ? S
                  : q('xAxis' === w ? e.defaultXAxisOptions : e.defaultYAxisOptions, T)),
                b &&
                  'yAxis' === w &&
            ...
            n || u
              ? ((this.isRadial = !0),
                ...
                this.labelCollector && g.labelCollectors.push(this.labelCollector))
              : (this.isRadial = !1);
            f && p && (f.axis = this);
            this.isCircular = p;
          }
        ...
        function D(f) {
          ...
          if (g) {
            ...
            if (b.isRadial) {
              var m = b.getPosition(
                this.pos,
                b.center[2] / 2 + p(k(u.distance, -25), b.center[2] / 2, -b.center[2] / 2)
              );
              'auto' === u.rotation
                ? g.attr({ rotation: a })
                : r(A) ||
                  (A =
                    b.chart.renderer.fontMetrics(g.styles && g.styles.fontSize).b - n.height / 2);
              r(F) ||
                (b.isCircular
                  ? (n.width > (b.len * b.tickInterval) / (b.max - b.min) && (v = 0),
                    (F =
                      a > v && a < 180 - v
                        ? 'left'
                        : a > 180 + v && a < 360 - v
                  ...
                  : (F = 'center'),
                g.attr({ align: F }));
              if ('auto' === F && 2 === b.tickPositions.length && b.isCircular) {
                90 < y && 180 > y ? (y = 180 - y) : 270 < y && 360 >= y && (y = 540 - y);
                180 < l && 360 >= l && (l = 360 - l);
                if (
                  b.pane.options.startAngle === w ||
                  b.pane.options.startAngle === w + 360 ||
                  b.pane.options.startAngle === w - 360
                )
                  c = 'start';
                F =
                  (-90 <= w && 90 >= w) || (-360 <= w && -270 >= w) || (270 <= w && 360 >= w)
                    ? 'start' === c
                      ? 'right'
                      : 'left'
                    : 'start' === c
                ...
                15 > y || (180 <= y && 195 > y)
                  ? (d = 0.3 * n.height)
                  : 15 <= y && 35 >= y
                  ? (d = 'start' === c ? 0 : 0.75 * n.height)
                  : 195 <= y && 215 >= y
                  ? (d = 'start' === c ? 0.75 * n.height : 0)
                  : 35 < y && 90 >= y
                  ? (d = 'start' === c ? 0.25 * -n.height : n.height)
                  : 215 < y && 270 >= y && (d = 'start' === c ? n.height : 0.25 * -n.height);
                15 > l
                  ? (h = 'start' === c ? 0.15 * -n.height : 0.15 * n.height)
                  : 165 < l && 180 >= l && (h = 'start' === c ? 0.15 * n.height : 0.15 * -n.height);
                g.attr({ align: F });
                g.translate(h, d + q);
              }
              f.pos.x = m.x + (u.x || 0);
        ...
        function z() {
          ...
          this.center &&
            ((this.transA = this.isCircular
              ...
              : (this.center[2] - this.center[3]) / 2 / (this.max - this.min || 1)),
        ...
        function U(f, g, b, n, u, w, a) {
          var k = this.axis;
          k.isRadial
            ? ((f = k.getPosition(this.pos, k.center[2] / 2 + n)), (g = ['M', g, b, 'L', f.x, f.y]))
            : (g = f.call(this, g, b, n, u, w, a));
          return g;
        }
        var M = [],
          S = {
        ...
        c.compose = function (f, g) {
          -1 === M.indexOf(f) &&
            (M.push(f),
            m(f, 'afterInit', B),
            m(f, 'autoLabelAlign', P),
            m(f, 'destroy', H),
            m(f, 'init', K),
            m(f, 'initialAxisTranslation', C));
          -1 === M.indexOf(g) &&
            (M.push(g),
            m(g, 'afterGetLabelPosition', D),
            m(g, 'afterGetPosition', G),
            v(g.prototype, 'getMarkPath', U));
          return f;
        };
      })(B || (B = {}));
      return B;
  ...
  z(
    ...
    [e['Series/Area/AreaSeries.js'], e['Core/Series/Point.js'], e['Core/Utilities.js']],
    function (e, d, h) {
      var c =
          (this && this.__extends) ||
          (function () {
    ...
    function (e, d, h, c, a, t, m) {
      ...
      a = (function (a) {
        ...
        c.prototype.highToXY = function (b) {
          var a = this.chart,
            g = this.xAxis.postTranslate(b.rectPlotX || 0, this.yAxis.len - b.plotHigh);
        ...
        c.prototype.translate = function () {
          ...
          b.points.forEach(function (f) {
            ...
            f.isNull
              ? (f.plotY = null)
              : ((f.plotLow = n),
                (f.plotHigh = a.translate(g ? b.modifyValue(u, f) : u, 0, 1, 0, 1)),
                g && (f.yBottom = f.plotHigh));
          });
          this.chart.polar &&
        ...
        c.prototype.getGraphPath = function (b) {
          ...
          c &&
            (!0 === c && (c = 'left'),
            (n.step = { left: 'right', center: 'center', right: 'left' }[c]));
          a = u.call(this, a);
          g = u.call(this, g);
          n.step = c;
          n = [].concat(b, a);
        ...
        c.prototype.drawDataLabels = function () {
          ...
          if (u) {
            ...
            if (A.enabled || this._hasPointLabels) {
              for (g = q; g--; )
                if ((n = a[g])) {
                  ...
                  n.below = v;
                  w
                    ? A.align || (A.align = v ? 'right' : 'left')
                    : A.verticalAlign || (A.verticalAlign = v ? 'top' : 'bottom');
                }
            ...
            if (c.enabled || this._hasPointLabels) {
              for (g = q; g--; )
                if ((n = a[g]))
                  (v = c.inside ? n.plotHigh < n.plotLow : n.plotHigh > n.plotLow),
                    (n.below = !v),
                    w
                      ? c.align || (c.align = v ? 'left' : 'right')
                      : c.verticalAlign || (c.verticalAlign = v ? 'bottom' : 'top');
        ...
        c.prototype.drawPoints = function () {
          ...
          for (c = 0; c < a; )
            (g = this.points[c]),
              (g.upperGraphic = g.graphic),
              (g.graphic = g.lowerGraphic),
              g.origProps && (k(g, g.origProps), delete g.origProps),
              c++;
        };
        ...
        b.prototype.drawPoints = function () {
          ...
          b.points.forEach(function (k) {
            ...
            'undefined' !== typeof k.plotY &&
              ((u = Math.round(y.width)),
              (n = Math.floor(y.x)),
              (w = n + u),
              (A = Math.round(u / 2)),
              (l = Math.floor(F ? k.q1Plot : k.lowPlot)),
              (d = Math.floor(F ? k.q3Plot : k.lowPlot)),
              (h = Math.floor(k.highPlot)),
              (m = Math.floor(k.lowPlot)),
              p ||
                ((k.graphic = p = v.g('point').add(b.group)),
                (k.stem = v.path().addClass('highcharts-boxplot-stem').add(p)),
                x && (k.whiskers = v.path().addClass('highcharts-boxplot-whisker').add(p)),
                F &&
                  (k.box = v
                    .path(void 0)
                ...
                (k.medianShape = v
                  ...
                  .add(p))),
              c.styledMode ||
                ((J.stroke = k.stemColor || a.stemColor || I),
                (J['stroke-width'] = r(k.stemWidth, a.stemWidth, a.lineWidth)),
                (J.dashstyle = k.stemDashStyle || a.stemDashStyle || a.dashStyle),
                k.stem.attr(J),
                x &&
                  ((L.stroke = k.whiskerColor || a.whiskerColor || I),
                  (L['stroke-width'] = r(k.whiskerWidth, a.whiskerWidth, a.lineWidth)),
                  (L.dashstyle = k.whiskerDashStyle || a.whiskerDashStyle || a.dashStyle),
                  k.whiskers.attr(L)),
                F &&
                  ((B.fill = k.fillColor || a.fillColor || I),
                  (B.stroke = a.lineColor || I),
                  (B['stroke-width'] = a.lineWidth || 0),
                  (B.dashstyle = k.boxDashStyle || a.boxDashStyle || a.dashStyle),
                  k.box.attr(B)),
                (H.stroke = k.medianColor || a.medianColor || I),
                (H['stroke-width'] = r(k.medianWidth, a.medianWidth, a.lineWidth)),
                (H.dashstyle = k.medianDashStyle || a.medianDashStyle || a.dashStyle),
                k.medianShape.attr(H)),
              (g = (k.stem.strokeWidth() % 2) / 2),
              (f = n + A + g),
              (p = [
                ['M', f, d],
                ['L', f, h],
              ...
              k.stem[q]({ d: p }),
              F &&
                ((g = (k.box.strokeWidth() % 2) / 2),
                (l = Math.floor(l) + g),
                (d = Math.floor(d) + g),
                (n += g),
                (w += g),
                (p = [['M', n, d], ['L', n, l], ['L', w, l], ['L', w, d], ['L', n, d], ['Z']]),
                k.box[q]({ d: p })),
              x &&
                ((g = (k.whiskers.strokeWidth() % 2) / 2),
                (h += g),
                (m += g),
                (t = /%$/.test(x) ? (A * parseFloat(x)) / 100 : x / 2),
                (p = [
                  ['M', f - t, h],
                  ['L', f + t, h],
                  ['M', f - t, m],
                ...
                k.whiskers[q]({ d: p })),
              (e = Math.round(k.medianPlot)),
              (g = (k.medianShape.strokeWidth() % 2) / 2),
              (e += g),
              (p = [
                ['M', n, e],
                ['L', w, e],
    ...
    function (e, d, h, c) {
      ...
      return (function () {
        ...
        c.prototype.drawLegendSymbol = function (a) {
          var c = this.chart,
            k = this.options,
            p = b(a.options.itemDistance, 20),
            l = k.ranges,
            d = k.connectorDistance;
          this.fontMetrics = c.renderer.fontMetrics(k.labels.style.fontSize);
          l && l.length && r(l[0].value)
            ? (q(l, function (b, g) {
              ...
              (d = 0 < d ? d : 0),
              (this.maxLabel = a),
              (this.movementX = 'left' === k.labels.align ? d : 0),
              (this.legendItemWidth = c + d + p),
        ...
        c.prototype.setOptions = function () {
          var c = this.ranges,
            k = this.options,
            l = this.chart.series[k.seriesIndex],
            q = this.legend.baseline,
            d = { zIndex: k.zIndex, 'stroke-width': k.borderWidth },
            h = { zIndex: k.zIndex, 'stroke-width': k.connectorWidth },
            e = {
              align: this.legend.options.rtl || 'left' === k.labels.align ? 'right' : 'left',
              zIndex: k.zIndex,
            },
            g = l.options.marker.fillOpacity,
            f = this.chart.styledMode;
          c.forEach(function (u, n) {
            f ||
              ((d.stroke = b(u.borderColor, k.borderColor, l.color)),
              (d.fill = b(
                u.color,
                k.color,
                1 !== g ? a(l.color).setOpacity(g).get('rgba') : l.color
              )),
              (h.stroke = b(u.connectorColor, k.connectorColor, l.color)));
        ...
        c.prototype.renderRange = function (b) {
          ...
          var g = b.center,
            ...
            n = c.align,
            w = a.connectorWidth,
            A = this.ranges[0].radius || 0,
            p = g - f - a.borderWidth / 2 + w / 2,
            h = this.fontMetrics;
          h = h.f / 2 - (h.h - h.f) / 2;
          var e = d.styledMode;
          ...
          q.bubbleItems.push(
            d
              .circle(A, g + ((p % 1 ? 1 : 0.5) - (w % 2 ? 0 : 0.5)), f)
              .attr(e ? {} : b.bubbleAttribs)
              .addClass(
                (e ? 'highcharts-color-' + l.colorIndex + ' ' : '') +
          ...
          q.connectors.push(
            d
              ...
              .attr(e ? {} : b.connectorAttribs)
              .addClass(
                (e ? 'highcharts-color-' + this.options.seriesIndex + ' ' : '') +
          ...
          b = d
            .text(this.formatLabel(b), m, n + h)
            .attr(e ? {} : b.labelAttribs)
            .css(e ? {} : c.style)
            .addClass('highcharts-bubble-legend-labels ' + (a.labels.className || ''))
            .add(this.legendSymbol);
          k.push(b);
          b.placed = !0;
        ...
        c.prototype.hideOverlappingLabels = function () {
          ...
          !this.options.labels.allowOverlap &&
            ...
            a.labels.forEach(function (b, c) {
              b.newOpacity
                ? b.newOpacity !== b.oldOpacity && a.connectors[c].show()
                : a.connectors[c].hide();
            }));
        };
          ...
          a.chart.series.forEach(function (a) {
            a.isBubble &&
              ...
              k.length &&
                ...
                (q = b(a.options.zMax, Math.max(q, m(k))))));
          });
          var h =
            d === q
              ? [{ value: q }]
              : [{ value: d }, { value: (d + q) / 2 }, { value: q, autoRanges: !0 }];
        ...
        c.prototype.predictBubbleSizes = function () {
          var b = this.chart,
            ...
            l = k ? b.legend.lastLineHeight : 0,
            d = b.plotSizeX,
            q = b.plotSizeY,
            g = b.series[this.options.seriesIndex];
          b = Math.ceil(g.minPxSize);
          var f = Math.ceil(g.maxPxSize),
            u = Math.min(q, d);
          g = g.options.maxSize;
          if (c.floating || !/%$/.test(g)) a = f;
          else if (
            ((g = parseFloat(g)),
            (a = ((u + l - a.h / 2) * g) / 100 / (g / 100 + 1)),
            (k && q - a >= d) || (!k && d - a >= q))
          )
            a = f;
      ...
      (function (c) {
        function b(b, a, c) {
          ...
          if (g && g.options.enabled && g.bubbleLegend && g.options.bubbleLegend.autoRanges && f) {
            ...
            b.call(this, a, c),
              g && g.options.enabled && g.bubbleLegend && (g.render(), r(g, k(g)));
        }
        function q(b) {
          b = b.series;
        ...
        function k(b) {
          ...
          for (g = 0; g < c; g++)
            if (
              (b[g].legendItemHeight && (b[g].itemHeight = b[g].legendItemHeight),
              b[g] === b[c - 1] ||
                (b[g + 1] && b[g]._legendItemPos[1] !== b[g + 1]._legendItemPos[1]))
            ) {
              a.push({ height: 0 });
              var u = a[a.length - 1];
        ...
        function h(b) {
          ...
          a &&
            a.ranges &&
            a.ranges.length &&
            (g.ranges.length && (g.autoRanges = !!g.ranges[0].autoRanges), this.destroyItem(a));
          0 <= f &&
            c.enabled &&
            g.enabled &&
            ((g.seriesIndex = f),
            (this.bubbleLegend = new d(g, this)),
        ...
        function v() {
          ...
          c &&
            ...
            c.bubbleLegend.visible !== b &&
              (c.update({ bubbleLegend: { enabled: b } }), (c.bubbleLegend.visible = b)),
            (this.visible = a));
        }
        function r(b, a) {
          var c = b.options.rtl,
          ...
          b.allItems.forEach(function (b, k) {
            ...
            if ((u = b.movementX) || (c && b.ranges))
              (u = c ? g - b.options.maxSize / 2 : g + u), b.legendGroup.attr({ translateX: u });
            k > a[n].step && n++;
        ...
        c.compose = function (c, k, d) {
          -1 === x.indexOf(c) &&
            (x.push(c), a({ legend: { bubbleLegend: e } }), l(c.prototype, 'drawChartBox', b));
    ...
    function (e, d, h) {
      ...
      d = (function (a) {
        ...
        d.prototype.haloPath = function (a) {
          return e.prototype.haloPath.call(
            this,
    ...
    function (e, d, h, c, a, t, m, l) {
      ...
      l = (function (b) {
        ...
        f.prototype.animate = function (b) {
          !b &&
            ...
            this.points.forEach(function (b) {
              ...
              f &&
                f.width &&
                (this.hasRendered || f.attr({ x: b.plotX, y: b.plotY, width: 1, height: 1 }),
                f.animate(this.markerAttribs(b), this.options.animation));
            }, this);
        };
        ...
        f.prototype.getRadius = function (b, f, a, g, c, k) {
          ...
          if (H(c)) {
            n.sizeByAbsoluteValue &&
              ((c = Math.abs(c - w)), (d = Math.max(f - w, Math.abs(b - w))), (b = 0));
            if (c < b) return a / 2 - 1;
            0 < d && (q = (c - b) / d);
          }
          u && 0 <= q && (q = Math.sqrt(q));
        ...
        f.prototype.translate = function () {
          ...
          for (f = a.length; f--; ) {
            var c = a[f];
            var k = g ? g[f] : 0;
            H(k) && k >= this.minPxSize / 2
              ? ((c.marker = B(c.marker, { radius: k, width: 2 * k, height: 2 * k })),
                (c.dlBox = { x: c.plotX - k, y: c.plotY - k, width: 2 * k, height: 2 * k }))
      ...
      e.prototype.beforePadding = function () {
        var b = this,
          ...
          l = this.min,
          h = {},
          e = Math.min(a.plotWidth, a.plotHeight),
          m = Number.MAX_VALUE,
          r = -Number.MAX_VALUE,
          x = this.max - l,
          t = f / x,
        ...
        this.series.forEach(function (f) {
          var g = f.options;
          !f.bubblePadding ||
            (!f.visible && a.options.chart.ignoreHiddenSeries) ||
            ((b.allowZoomOutside = !0),
            B.push(f),
            d &&
              (['minSize', 'maxSize'].forEach(function (b) {
                var f = g[b],
                  a = /%$/.test(f);
                f = I(f);
                h[b] = a ? (e * f) / 100 : f;
              }),
              (f.minPxSize = h.minSize),
              (f.maxPxSize = Math.max(h.maxSize, h.minSize)),
              (f = f.zData.filter(H)),
              f.length &&
                ((m = y(
                  g.zMin,
                  v(p(f), !1 === g.displayNegative ? g.zThreshold : -Number.MAX_VALUE, m)
                )),
                (r = y(g.zMax, Math.max(r, k(f)))))));
        });
        B.forEach(function (f) {
          ...
          if (0 < x)
            for (; g--; )
              if (H(a[g]) && b.dataMin <= a[g] && a[g] <= b.max) {
        ...
        B.length &&
          ...
          !this.logarithmic &&
          ((w -= f),
          (t *= (f + Math.max(0, c) - Math.min(w, f)) / f),
          [
            ['min', 'userMin', c],
            ['max', 'userMax', w],
          ].forEach(function (f) {
      ...
      t = (function (c) {
        ...
        d.prototype.translate = function () {
          var a = this,
            ...
            f = a.chart,
            u = a.xAxis.isRadial,
            n = Math.max(f.chartWidth, f.chartHeight) + 999,
            w;
          r.translate.apply(a);
          a.points.forEach(function (l) {
            var h = l.shapeArgs || {},
              A = a.options.minPointLength;
            ...
            u
              ? ((g = l.barX + q),
                (l.shapeType = 'arc'),
                (l.shapeArgs = a.polarArc(e + p, e, g, g + l.pointWidth)))
              : ((h.height = p),
                (h.y = e),
                (A = h.x),
                (A = void 0 === A ? 0 : A),
                ...
                (l.tooltipPos = f.inverted
                  ? [
                      c.len + c.pos - f.plotLeft - e - p / 2,
                      d.len + d.pos - f.plotTop - A - h / 2,
                      p,
                    ]
                  : [d.left - f.plotLeft + A + h / 2, c.pos - f.plotTop + e + p / 2, p]));
          });
        };
        ...
        d.prototype.adjustForMissingColumns = function () {
          return r.adjustForMissingColumns.apply(this, arguments);
        };
    ...
    function (e, d, h) {
      ...
      h = (function (d) {
        ...
        h.prototype.translate = function () {
          ...
          var h = b.yAxis,
            e = k.threshold,
            m = (b.translatedThreshold = h.getThreshold(e)),
            x = l(k.minPointLength, 5),
            r = b.getColumnMetrics(),
            I = r.width,
            g = (b.barW = Math.max(I, 1 + 2 * d)),
            f = (b.pointXOffset = r.offset);
          c.inverted && (m -= 0.5);
          ...
          b.points.forEach(function (a) {
            ...
            a.barX = d;
            a.pointWidth = I;
            a.tooltipPos = c.inverted
              ? [h.len + h.pos - c.plotLeft - u, b.xAxis.len - d - q, n]
              : [d + q, u + h.pos - c.plotTop, n];
            u = e + (a.total || a.y);
            'percent' === k.stacking && (u = e + (0 > a.y) ? -100 : 100);
            u = h.toPixels(u, !0);
            var r = (v = c.plotHeight - u - (c.plotHeight - m)) ? (q * (p - u)) / v : 0;
            var y = v ? (q * (p + n - u)) / v : 0;
            v = d - r + q;
            r = d + r + q;
            var K = d + y + q;
      ...
      var r = (function (a) {
        ...
        b.prototype.getColumnMetrics = function () {
          return (
            ...
            d.prototype.getColumnMetrics.call(this)
          );
        };
      ...
      a = (function (b) {
        ...
        a.prototype.translate = function () {
          ...
          this.points.forEach(function (d) {
            var g = q(a.dial, d.dial),
              f = (p(k(g.radius, '80%')) * c[2]) / 200,
              u = (p(k(g.baseLength, '70%')) * f) / 100,
              n = (p(k(g.rearLength, '10%')) * f) / 100,
              w = g.baseWidth || 3,
              l = g.topWidth || 1,
              h = a.overshoot,
              e = b.startAngleRad + b.translate(d.y, null, null, null, !0);
            if (x(h) || !1 === a.wrap)
              (h = x(h) ? (h / 180) * Math.PI : 0),
                (e = r(e, b.startAngleRad - h, b.endAngleRad + h));
            e = (180 * e) / Math.PI;
            d.shapeType = 'path';
            d.shapeArgs = {
              d: g.path || [
        ...
        a.prototype.drawPoints = function () {
          ...
          b.points.forEach(function (f) {
            ...
            c
              ? (c.animate(d), (d.d = n))
              : (f.graphic = u[f.shapeType](d)
                  .attr({ rotation: d.rotation, zIndex: 1 })
                  .addClass('highcharts-dial')
                  .add(b.group));
            if (!a.styledMode)
              f.graphic[c ? 'animate' : 'attr']({
                stroke: k.borderColor || 'none',
                'stroke-width': k.borderWidth || 0,
                fill: k.backgroundColor || h.neutralColor100,
              });
          });
          d
            ? d.animate({ translateX: c[0], translateY: c[1] })
            : ((b.pivot = u
                .circle(0, 0, k(f.radius, 5))
                .attr({ zIndex: 2 })
        ...
        a.prototype.animate = function (b) {
          ...
          b ||
            a.points.forEach(function (b) {
              var c = b.graphic;
              c &&
                (c.attr({ rotation: (180 * a.yAxis.startAngleRad) / Math.PI }),
                c.animate({ rotation: b.shapeArgs.rotation }, a.options.animation));
            });
        };
  ...
  z(
    ...
    [e['Core/Chart/Chart.js'], e['Core/Series/Point.js'], e['Core/Series/SeriesRegistry.js']],
    function (e, d, h) {
      var c =
        (this && this.__extends) ||
        (function () {
        ...
        h.prototype.select = function () {
          ...
          this.isParentNode
            ? ((a.getSelectedPoints = a.getSelectedParentNodes),
              d.prototype.select.apply(this, arguments),
              (a.getSelectedPoints = e.prototype.getSelectedPoints))
            : d.prototype.select.apply(this, arguments);
        };
        return h;
    ...
    function (e, d, h) {
        ...
        onMouseMove: function (a, c) {
          if (a.fixedPosition && a.inDragMode) {
            ...
            if (5 < Math.abs(c) || 5 < Math.abs(h))
              (e = a.fixedPosition.plotX - c),
                (x = a.fixedPosition.plotY - h),
                d.isInsidePlot(e, x) &&
                  ((a.plotX = e),
                  (a.plotY = x),
                  (a.hasDragged = !0),
      ...
      c(e, 'load', function () {
        var a = this,
          ...
          e;
        a.container &&
          (d = c(a.container, 'mousedown', function (d) {
            var l = a.hoverPoint;
            l &&
              l.series &&
              l.series.hasDraggableNodes &&
              l.series.options.draggable &&
              (l.series.onMouseDown(l, d),
              (h = c(a.container, 'mousemove', function (b) {
      ...
      verlet: {
        ...
        barycenter: function () {
          ...
          this.nodes.forEach(function (a) {
            a.fixedPosition ||
              ((a.plotX -= h / a.mass / a.degree), (a.plotY -= c / a.mass / a.degree));
          });
        },
        ...
        attractive: function (d, h, c) {
          var a = d.getMass(),
            e = -c.x * h * this.diffTemperature;
          h = -c.y * h * this.diffTemperature;
          d.fromNode.fixedPosition ||
            ((d.fromNode.plotX -= (e * a.fromNode) / d.fromNode.degree),
            (d.fromNode.plotY -= (h * a.fromNode) / d.fromNode.degree));
          d.toNode.fixedPosition ||
            ((d.toNode.plotX += (e * a.toNode) / d.toNode.degree),
            (d.toNode.plotY += (h * a.toNode) / d.toNode.degree));
        },
        integrate: function (d, h) {
          var c = -d.options.friction,
            a = d.options.maxSpeed,
            e = (h.plotX + h.dispX - h.prevX) * c;
        ...
        getK: function (d) {
          return Math.pow((d.box.width * d.box.height) / d.nodes.length, 0.5);
        },
      },
      euler: {
        ...
        attractive: function (d, e, c, a) {
          ...
          e *= c.y / a;
          d.fromNode.fixedPosition ||
            ((d.fromNode.dispX -= (m * h.fromNode) / d.fromNode.degree),
            (d.fromNode.dispY -= (e * h.fromNode) / d.fromNode.degree));
          d.toNode.fixedPosition ||
            ((d.toNode.dispX += (m * h.toNode) / d.toNode.degree),
            (d.toNode.dispY += (e * h.toNode) / d.toNode.degree));
        },
        integrate: function (d, e) {
          ...
          0 !== c &&
            ((e.plotX += (e.dispX / c) * Math.min(Math.abs(e.dispX), d.temperature)),
            (e.plotY += (e.dispY / c) * Math.min(Math.abs(e.dispY), d.temperature)));
        },
        getK: function (d) {
          return Math.pow((d.box.width * d.box.height) / d.nodes.length, 0.3);
        },
      },
    };
  });
              ...
              this.body
                ? a
                  ? ((this.isInternal = !0),
                    this.divideBox(),
                    !0 !== this.body &&
                      (this.nodes[this.getBoxPosition(this.body)].insert(this.body, a - 1),
                      (this.body = !0)),
                    this.nodes[this.getBoxPosition(c)].insert(c, a - 1))
                  : ((a = new h({ top: c.plotX, left: c.plotY, width: 0.1, height: 0.1 })),
                    (a.body = c),
                    (a.isInternal = !1),
                    this.nodes.push(a))
      ...
      l(h.layouts['reingold-fruchterman'].prototype, {
        ...
        step: function () {
          ...
          b.enableSimulation &&
            ...
            b.maxIterations-- && isFinite(b.temperature) && !b.isStable()
              ? (b.simulation && h.win.cancelAnimationFrame(b.simulation),
                (b.simulation = h.win.requestAnimationFrame(function () {
                  b.step();
                })))
              : (b.simulation = !1));
        },
        ...
        attractiveForces: function () {
          ...
          b.links.forEach(function (e) {
            e.fromNode &&
              e.toNode &&
              ((a = b.getDistXY(e.fromNode, e.toNode)),
              (c = b.vectorLength(a)),
              0 !== c && ((d = b.attractiveForce(c, b.k)), b.force('attractive', e, d, a, c)));
          });
        },
      ...
      d(e, 'render', function () {
        function b(a) {
          a.maxIterations-- &&
            ...
            !a.isStable() &&
            !a.enableSimulation &&
            (a.beforeStep && a.beforeStep(), a.step(), (d = !1), (c = !0));
        }
        var c = !1;
    ...
    function (e, d, h) {
      ...
      d.networkgraphIntegrations.packedbubble = {
        ...
        barycenter: function () {
          ...
          b.forEach(function (l) {
            a.options.splitSeries && !l.isParentNode
              ? ((e = l.series.parentNode.plotX), (k = l.series.parentNode.plotY))
              : ((e = d.width / 2), (k = d.height / 2));
            l.fixedPosition ||
              ((l.plotX -= ((l.plotX - e) * c) / (l.mass * Math.sqrt(b.length))),
              (l.plotY -= ((l.plotY - k) * c) / (l.mass * Math.sqrt(b.length))));
          });
        },
      ...
      d.layouts.packedbubble = t(c, {
        ...
        isStable: function () {
          ...
          return (
            (1 > Math.abs((10 * this.systemTemperature) / Math.sqrt(this.nodes.length)) &&
              0.00001 > a) ||
            0 >= this.temperature
          );
        },
        setCircularPositions: function () {
          ...
          d.forEach(function (d, l) {
            a.options.splitSeries && !d.isParentNode
              ? ((e = d.series.parentNode.plotX), (k = d.series.parentNode.plotY))
        ...
        repulsiveForces: function () {
          ...
          a.nodes.forEach(function (k) {
            ...
            a.nodes.forEach(function (h) {
              ...
              k === h ||
                k.fixedPosition ||
                (!a.options.seriesInteraction && k.series !== h.series) ||
                ((b = a.getDistXY(k, h)),
                (d = a.vectorLength(b) - (k.marker.radius + h.marker.radius + e)),
                0 > d &&
                  ((k.degree += 0.01),
                  k.neighbours++,
                  (c = a.repulsiveForce(-d / Math.sqrt(k.neighbours), a.k, k, h))),
                a.force('repulsive', k, c * h.mass, b, h, d));
            });
          });
        },
        applyLimitBox: function (a) {
          if (this.options.splitSeries && !a.isParentNode && this.options.parentNodeLimit) {
            ...
            0 > e && e > -2 * a.marker.radius && ((a.plotX -= 0.01 * d.x), (a.plotY -= 0.01 * d.y));
          }
      ...
      e = (function (a) {
        ...
        c.prototype.accumulateAllPoints = function (a) {
          ...
          for (f = 0; f < b.series.length; f++)
            if (
              ((a = b.series[f]),
              (a.is('packedbubble') && a.visible) || !b.options.chart.ignoreHiddenSeries)
            )
              for (d = 0; d < a.yData.length; d++)
                c.push([null, null, a.yData[d], a.index, d, { id: d, marker: { radius: 0 } }]);
          return c;
        };
        c.prototype.addLayout = function () {
          ...
          b ||
            ((this.chart.graphLayoutsStorage = b = {}), (this.chart.graphLayoutsLookup = c = []));
          var e = b[a.type];
          e ||
            ((a.enableSimulation = q(g.forExport) ? !g.forExport : a.enableSimulation),
            (b[a.type] = e = new d.layouts[a.type]()),
            e.init(a),
            c.splice(e.index, 0, e));
          this.layout = e;
          this.points.forEach(function (a) {
            a.mass = 2;
            a.degree = 1;
        ...
        c.prototype.addSeriesLayout = function () {
          var a = this.options.layoutAlgorithm,
            b = this.chart.graphLayoutsStorage,
            c = this.chart.graphLayoutsLookup,
            g = z(a, a.parentNodeOptions, {
              enableSimulation: this.layout.options.enableSimulation,
            });
          var e = b[a.type + '-series'];
          e ||
            ((b[a.type + '-series'] = e = new d.layouts[a.type]()),
            e.init(g),
            c.splice(e.index, 0, e));
        ...
        c.prototype.checkOverlap = function (a, b) {
          var c = a[0] - b[0],
            f = a[1] - b[1];
          return -0.001 > Math.sqrt(c * c + f * f) - Math.abs(a[2] + b[2]);
        };
        c.prototype.createParentNodes = function () {
          ...
          d ||
            ...
            a.parentNode && ((g.plotX = a.parentNode.plotX), (g.plotY = a.parentNode.plotY)),
            (a.parentNode = g),
            c.addElementsToCollection([a], c.series),
            c.addElementsToCollection([g], c.nodes));
        };
        ...
        c.prototype.drawGraph = function () {
          if (this.layout && this.layout.options.splitSeries) {
            ...
            var c = {
              fill: b.fillColor || m(this.color).brighten(0.4).get(),
        ...
        c.prototype.getPointRadius = function () {
          var a = this,
            ...
            d = a.options,
            g = d.useSimulation,
            e = Math.min(c.plotWidth, c.plotHeight),
            k = {},
            h = [],
            l = c.allDataPoints,
            q,
        ...
        c.prototype.onMouseUp = function (a) {
          if (a.fixedPosition && !a.removed) {
            ...
            d &&
              f.options.dragBetweenSeries &&
              d.nodes.forEach(function (d) {
                a &&
                  a.marker &&
                  d !== a.series.parentNode &&
                  ((b = f.getDistXY(a, d)),
                  (c = f.vectorLength(b) - d.marker.radius - a.marker.radius),
                  0 > c &&
                    (d.series.addPoint(z(a.options, { plotX: a.plotX, plotY: a.plotY }), !1),
                    f.removeElementFromCollection(a, f.nodes),
                    a.remove()));
              });
        ...
        c.prototype.placeBubbles = function (a) {
          ...
          if (a.length) {
            ...
            if (1 < a.length)
              for (
                f.push([[0, 0 - a[1][2] - a[0][2], a[1][2], a[1][3], a[1][4]]]), h = 2;
                h < a.length;
                h++
              )
                (a[h][2] = a[h][2] || 1),
                  (k = c(f[d][g], f[d - 1][e], a[h])),
                  b(k, f[d][0])
                    ? (f.push([]), (e = 0), f[d + 1].push(c(f[d][g], f[d][0], a[h])), d++, (g = 0))
                    : 1 < d && f[d - 1][e + 1] && b(k, f[d - 1][e + 1])
                    ? (e++, f[d].push(c(f[d][g], f[d - 1][e], a[h])), g++)
                    : (g++, f[d].push(k));
            this.chart.stages = f;
        ...
        c.prototype.positionBubble = function (a, b, c) {
          var f = Math.sqrt,
            ...
            e = Math.pow,
            k = Math.abs;
          f = f(e(a[0] - b[0], 2) + e(a[1] - b[1], 2));
          g = g((e(f, 2) + e(c[2] + b[2], 2) - e(c[2] + a[2], 2)) / (2 * (c[2] + b[2]) * f));
          d = d(k(a[0] - b[0]) / f);
          a =
            (0 > a[1] - b[1] ? 0 : Math.PI) + g + d * (0 > (a[0] - b[0]) * (a[1] - b[1]) ? 1 : -1);
          return [
        ...
        c.prototype.resizeRadius = function () {
          ...
          if (1e-10 < Math.abs(c - 1)) {
            ...
            this.placeBubbles(b);
          } else (a.diffY = k / 2 + e - l - (q - l) / 2), (a.diffX = h / 2 + g - m - (r - m) / 2);
        };
        ...
        c.prototype.translate = function () {
          ...
          if (g) var e = a.allDataPoints;
          else (e = this.placeBubbles(a.allDataPoints)), (this.options.draggable = !1);
          for (d = 0; d < e.length; d++)
            if (e[d][3] === c) {
              var h = b[e[d][4]];
              var l = D(e[d][2], void 0);
              g ||
                ((h.plotX = e[d][0] - a.plotLeft + a.diffX),
                (h.plotY = e[d][1] - a.plotTop + a.diffY));
              B(l) &&
                ((h.marker = k(h.marker, { radius: l, width: 2 * l, height: 2 * l })),
                (h.radius = l));
            }
          g && this.deferLayout();
          p(this, 'afterTranslate');
        };
        c.defaultOptions = z(r.defaultOptions, {
          minSize: '10%',
          maxSize: '50%',
          sizeBy: 'area',
          zoneAxis: 'y',
    ...
    function (e, d, h, c) {
      ...
      c = (function (c) {
        ...
        d.prototype.getGraphPath = function () {
          for (var a = r.prototype.getGraphPath.call(this), b = a.length + 1; b--; )
  ...
  z(
    ...
    [e['Extensions/Stacking.js'], e['Core/Utilities.js']],
    function (e, d) {
      var h = d.addEvent,
        c = d.objectEach,
        a;
  ...
  z(
    ...
    [e['Series/Column/ColumnSeries.js'], e['Core/Series/Point.js'], e['Core/Utilities.js']],
    function (e, d, h) {
      var c =
          (this && this.__extends) ||
          (function () {
      ...
      a = (function (a) {
            ...
            if (C && v(r)) {
              ...
              if (a) {
                if (l) {
                  ...
                  if ('overlap' === a) {
                    ...
                    0 <= G
                      ? ((y = t.threshold + t.posTotal), (t.posTotal -= G))
                      : ((y = t.threshold + t.negTotal), (t.negTotal -= G), (y -= G)),
                      !t.posTotal &&
                  ...
                  C.height = Math.abs(C.y - (b.translate(G, !1, !0, !1, !0) || 0));
                  if ((G = b.waterfall.dummyStackItem))
                    (G.x = p),
                      (G.label = l[p].label),
                      G.setOffset(
                        this.pointXOffset || 0,
                ...
                (y = Math.max(h, h + G) + t[0]),
                  (C.y = b.translate(y, !1, !0, !1, !0) || 0),
                  m.isSum
                    ? ((C.y = b.translate(t[1], !1, !0, !1, !0) || 0),
                      (C.height = Math.min(b.translate(t[0], !1, !0, !1, !0) || 0, b.len) - C.y),
                      (m.below = t[1] <= e))
                    : m.isIntermediateSum
                    ? (0 <= G ? ((r = t[1] + k), (G = k)) : ((r = k), (G = t[1] + k)),
                      b.reversed && ((r ^= G), (G ^= r), (r ^= G)),
                      (C.y = b.translate(r, !1, !0, !1, !0) || 0),
                      (C.height = Math.abs(
                        C.y - Math.min(b.translate(G, !1, !0, !1, !0) || 0, b.len)
                      )),
                      (k += t[1]),
                      (m.below = r <= e))
                    : ((C.height =
                        0 < r
                          ? (b.translate(h, !1, !0, !1, !0) || 0) - C.y
                          : (b.translate(h, !1, !0, !1, !0) || 0) -
                            (b.translate(h - r, !1, !0, !1, !0) || 0)),
                      (h += r),
                      (m.below = h < e)),
              ...
              C.height <= c && !m.isNull
                ? ((C.height = c),
                  (C.y -= d),
                  (m.plotY = C.y),
                  (m.minPointLengthOffset = 0 > m.y ? -d : d))
                : (m.isNull && (C.width = 0), (m.minPointLengthOffset = 0));
              G = m.plotY + (m.negative ? C.height : 0);
              m.below && (m.plotY += C.height);
              m.tooltipPos &&
                (this.chart.inverted ? (m.tooltipPos[0] = b.len - G) : (m.tooltipPos[1] = G));
            }
          }
        };
        c.prototype.processData = function (b) {
          ...
          for (r = l = k = m = q = 0; r < e; r++) {
            ...
            'sum' === t || v.isSum
              ? (d[r] = p(l))
              : 'intermediateSum' === t || v.isIntermediateSum
              ? ((d[r] = p(k)), (k = 0))
              : ((l += t), (k += t));
            m = Math.min(l, m);
            q = Math.max(l, q);
          ...
          c.stacking || ((this.dataMin = m + h), (this.dataMax = q));
        };
        ...
        c.prototype.getCrispPath = function () {
          ...
          for (p = 1; p < c; p++) {
            ...
            v &&
              ...
              ((v = v[p - 1]),
              l
                ? ((v = v.connectorThreshold),
                  (x = Math.round(b.translate(v, 0, 1, 0, 1) + (k ? x : 0)) - d))
                : (x = t.y + r.minPointLengthOffset + e - d),
              m.push(
                ['M', (t.x || 0) + (h ? 0 : t.width || 0), x],
                ['L', (q.x || 0) + (h ? q.width || 0 : 0), x]
              ));
            t &&
              m.length &&
              ((!l && 0 > r.y && !k) || (0 < r.y && k)) &&
              ((r = m[m.length - 2]) && 'number' === typeof r[2] && (r[2] += t.height || 0),
              (r = m[m.length - 1]) && 'number' === typeof r[2] && (r[2] += t.height || 0));
          }
          return m;
        };
        c.prototype.drawGraph = function () {
        ...
        c.prototype.setStackedPoints = function () {
          function a(a, b, c, d) {
            ...
            else (z.stackState[0] = a), (H = z.stackState.length);
            z.stackState.push(z.stackState[H - 1] + b);
          }
          var b = this.options,
  ...
  z(
    ...
    function (e, d, h, c, a, t, m, l, r) {
      ...
      D.searchPointByAngle = function (a) {
        ...
        return this.searchKDTree({
          clientX:
            180 +
            (-180 / Math.PI) *
              Math.atan2(a.chartX - c[0] - b.plotLeft, a.chartY - c[1] - b.plotTop),
        });
      };
      ...
      D.toXY = function (a) {
        ...
        p(g) &&
          ((d = k ? d.postTranslate(g, m) : c.postTranslate(e, m)),
          (a.plotX = a.polarPlotX = d.x - b.plotLeft),
          (a.plotY = a.polarPlotY = d.y - b.plotTop));
        this.kdByAngle
          ? ((b = ((e / Math.PI) * 180 + c.pane.options.startAngle) % 360),
            0 > b && (b += 360),
            (a.clientX = b))
          : (a.clientX = a.plotX);
      };
      m.spline &&
        (e(m.spline.prototype, 'getPointSpline', function (a, b, c, d) {
          this.chart.polar
            ? d
        ...
        m.areasplinerange &&
          (m.areasplinerange.prototype.getPointSpline = m.spline.prototype.getPointSpline));
      b(
        t,
        'afterTranslate',
        function () {
              ...
              (this.hasClipCircleSetter = !!this.eventsToUnbind.push(
                b(this, 'afterRender', function () {
                  if (a.polar) {
                    ...
                    this.clipCircle
                      ? this.clipCircle.animate({ x: b[0], y: b[1], r: b[2] / 2, innerR: b[3] / 2 })
      ...
      var y = function (a, b) {
        ...
        if (d.polar)
          if (c.isRadialBar)
            b ||
              ((c.startAngleRad = v(c.translatedThreshold, c.xAxis.startAngleRad)),
              h.seriesTypes.pie.prototype.animate.call(c, b));
          else {
            if (d.renderer.isSVG)
                ...
                if (!b) {
                  ...
                  c.points.forEach(function (a) {
                    ...
                    p &&
                      q &&
                      (p.attr({ r: y, innerR: y }),
                      p.animate({ r: r, innerR: t }, c.options.animation));
                  });
                }
              } else
                b
                  ? ((a = {
                    ...
                    f.attr(a),
                    g && g.attr(a))
                  : ((a = { translateX: l, translateY: m, scaleX: 1, scaleY: 1 }),
                    f.animate(a, e),
                    g && g.animate(a, e));
          }
        else a.call(this, b);
          ...
          if (e.isRadial) {
            ...
            for (; e--; ) {
              ...
              if (d.inverted) {
                ...
                if (c && g.stacking) {
                  if (
                    ((B = g.stacking.stacks[(0 > B ? '-' : '') + this.stackKey]),
                    this.visible && B && B[z] && !b.isNull)
                  ) {
                ...
                else if (E > t || D < v) E = D = m;
                g.min > g.max && (E = D = h ? m : 0);
                E += l;
                D += l;
                k && (b.barX = y += k[3] / 2);
                z = Math.max(y, 0);
                ...
                b.plotY =
                  (q(this.translatedThreshold) && (E < this.translatedThreshold ? E : D)) - l;
              } else
                (E = y + l), (b.shapeArgs = this.polarArc(b.yBottom, b.plotY, E, E + b.pointWidth));
              this.toXY(b);
              d.inverted
                ? ((y = g.postTranslate(b.rectPlotY, y + b.pointWidth / 2)),
  ...
  z(
    ...
    [e['Core/Globals.js'], e['Core/Axis/RadialAxis.js'], e['Series/Bubble/BubbleSeries.js']],
    function (e, d, h) {
