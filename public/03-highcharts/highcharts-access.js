...
(function (b) {
    ...
    function (b, e) {
      ...
      return {
        ...
        reverseChildNodes: function (b) {
          for (var m = b.childNodes.length; m--; ) b.appendChild(b.childNodes[m]);
        },
  ...
  v(
    ...
    [b['Accessibility/Utils/HTMLUtilities.js'], b['Core/Globals.js'], b['Core/Utilities.js']],
    function (b, e, q) {
      function n(a) {
        var c = a.chart,
          d = {},
        ...
        return c.langFormat('accessibility.axis.timeRange' + b, {
          chart: c,
          axis: a,
          range: g.replace('.0', ''),
        });
        ...
        var c = a.chart,
          d =
            (c.options &&
              ...
              c.options.accessibility.screenReaderSection.axisRangeDateFormat) ||
            '',
          b = function (f) {
      ...
      return {
        getChartTitle: function (a) {
          return k(
            a.options.title.text || a.langFormat('accessibility.defaultChartTitle', { chart: a })
          );
        },
        ...
        getAxisRangeDescription: function (a) {
          var c = a.options || {};
          return c.accessibility && 'undefined' !== typeof c.accessibility.rangeDescription
        ...
        scrollToPoint: function (c) {
          ...
          if ((f = d && d.scrollbar) && g(f.to) && g(f.from)) {
            ...
            a(f, 'changed', { from: f.from, to: f.to, trigger: 'scrollbar', DOMEvent: null });
          }
        },
      };
    }
  ...
  v(b, 'Accessibility/KeyboardNavigationHandler.js', [b['Core/Utilities.js']], function (b) {
    ...
    e.prototype = {
      run: function (b) {
        ...
        m
          ? (n = m[1].call(this, e, b))
          : 9 === e && (n = this.response[b.shiftKey ? 'prev' : 'next']);
        return n;
      },
    };
    return e;
  ...
  v(
    ...
    [b['Core/Globals.js'], b['Accessibility/Utils/HTMLUtilities.js'], b['Core/Utilities.js']],
    function (b, e, q) {
      var n = b.doc,
        w = e.removeElement;
      b = q.extend;
  ...
  v(
    ...
    function (b, e, q, n, r, x) {
      ...
      m.prototype = {
        ...
        fireEventOnWrappedOrUnwrappedElement: function (c, b) {
          var f = b.type;
        ...
        createProxyButton: function (a, c, b, g, p) {
          var f = a.element,
            ...
            k = d({ 'aria-label': f.getAttribute('aria-label') }, b);
          Object.keys(k).forEach(function (a) {
            null !== k[a] && y.setAttribute(a, k[a]);
          });
            ...
            .forEach(function (d) {
              ...
              b.addEvent(
                ...
                function (c) {
                  ...
                  c.stopPropagation();
                  'touchstart' !== d && 'touchmove' !== d && 'touchend' !== d && c.preventDefault();
                },
                { passive: !1 }
              );
            });
    ...
    function (b, e, q, n, r) {
      ...
      w.prototype = {
        init: function (c, a) {
          ...
          f.addEvent(c.renderTo, 'mouseout', function () {
        ...
        update: function (c) {
          ...
          a && a.enabled && c && c.length
            ? ((this.modules = c.reduce(function (a, c) {
        ...
        onKeydown: function (c) {
          c = c || l.event;
          var a,
            b = this.modules && this.modules.length && this.modules[this.currentModuleIx];
          this.exiting = this.keyboardReset = !1;
          if (b) {
            var f = b.run(c);
            f === b.response.success
              ? (a = !0)
              : f === b.response.prev
              ? (a = this.prev())
              : f === b.response.next && (a = this.next());
        ...
        removeExitAnchor: function () {
          this.exitAnchor &&
            ...
            (this.exitAnchor.parentNode.removeChild(this.exitAnchor), delete this.exitAnchor);
        },
        addExitAnchorEventsToEl: function (c) {
          ...
          this.eventProvider.addEvent(c, 'focus', function (c) {
            c = c || l.event;
            (c.relatedTarget && a.container.contains(c.relatedTarget)) || b.exiting
              ? (b.exiting = !1)
              : ((b.tabbingInBackwards = !0),
                ...
                b.modules &&
                  ...
                  (c = b.modules[b.currentModuleIx]) && c.validate && !c.validate()
                    ? b.prev()
                    : c && c.init(-1)));
          });
        },
  ...
  v(
    ...
    function (b, e, q, n, r, x, m, l, k) {
      ...
      c(n, 'afterColorizeItem', function (a) {
        var c = a.item;
        this.chart.options.accessibility.enabled &&
          c &&
          c.a11yProxyElement &&
          c.a11yProxyElement.setAttribute('aria-pressed', a.visible ? 'true' : 'false');
      });
      e = function () {};
      e.prototype = new x();
      b(e.prototype, {
        init: function () {
          ...
          this.addEvent(n, 'afterPositionItem', function (c) {
        ...
        updateLegendItemProxyVisibility: function () {
          ...
          (a.allItems || []).forEach(function (d) {
            var t = d.pageIx || 0,
              f = d._legendItemPos ? d._legendItemPos[1] : 0,
        ...
        updateProxyPositionForItem: function (c) {
          var b = a(this.proxyElementsList, function (a) {
            return a.item === c;
          });
        ...
        updateLegendTitle: function () {
          var a = this.chart,
            c = L(
              ((a.legend && a.legend.options.title && a.legend.options.title.text) || '').replace(
                /<br ?\/?>/g,
                ' '
              )
            );
        ...
        onKbdArrowKey: function (a, c) {
          ...
          return t.highlightLegendItem(this.highlightedLegendItemIx + c)
            ? ((this.highlightedLegendItemIx += c), d.success)
            : 1 < g && f.keyboardNavigation.wrapAround
            ? (a.init(c), d.success)
            : d[0 < c ? 'next' : 'prev'];
        },
  ...
  v(
    ...
    function (b, e, q, n, r, x) {
      ...
      b.prototype.highlightExportItem = function (c) {
        var a = this.exportDivElements && this.exportDivElements[c],
      ...
      b.prototype.highlightLastExportItem = function () {
        ...
        if (this.exportDivElements)
          for (c = this.exportDivElements.length; c--; ) if (this.highlightExportItem(c)) return !0;
        return !1;
      };
      b = function () {};
      b.prototype = new q();
      e(b.prototype, {
        ...
        onChartRender: function () {
          ...
          b &&
            ...
            (a = m(this.chart)),
            (this.exportButtonProxy = this.createProxyButton(a, this.exportProxyGroup, {
              'aria-label': c.langFormat('accessibility.exporting.menuButtonLabel', { chart: c }),
              'aria-expanded': !1,
            })));
        },
        addAccessibleContextMenuAttribs: function () {
          ...
          a &&
            ...
            (a = a[0] && a[0].parentNode)) &&
            (a.removeAttribute('aria-hidden'),
            a.setAttribute(
              'aria-label',
              c.langFormat('accessibility.exporting.chartMenuLabel', { chart: c })
            ));
        },
        getKeyboardNavigation: function () {
          var c = this.keyCodes,
        ...
        onKbdPrevious: function (c) {
          ...
          return b.keyboardNavigation.wrapAround
            ? (a.highlightLastExportItem(), c.success)
            : c.prev;
        },
        ...
        onKbdClick: function (c) {
          ...
          this.isExportMenuShown
            ? this.fakeClickEvent(b)
            : (this.fakeClickEvent(f), a.highlightExportItem(0));
  ...
  v(
    ...
    function (b, e, q, n, r, x, m, l, k) {
        ...
        if (!g(a)) {
          for (; t--; ) {
            ...
            if (
              !g(h) &&
              ((h =
                (a.plotX - h.plotX) * (a.plotX - h.plotX) * (b || 1) +
      ...
      b.prototype.highlightAdjacentPoint = function (a) {
        ...
        if (d) {
          if (
            ...
            (f = l[f + (a ? 1 : -1)]),
            !f && b && (f = b.points[a ? 0 : b.points.length - 1]),
            !f)
          )
            return !1;
        ...
        return c(f)
          ? ((b = f.series),
            g(b)
              ? (this.highlightedPoint = a ? b.points[b.points.length - 1] : b.points[0])
      ...
      q.prototype.highlightFirstValidPoint = function () {
        ...
        var d = a.length;
        if (a && d) {
          for (var f = b; f < d; ++f) if (!c(a[f])) return a[f].highlight();
          for (; 0 <= b; --b) if (!c(a[b])) return a[b].highlight();
        }
        return !1;
      };
      b.prototype.highlightAdjacentSeries = function (c) {
        ...
        if (!this.highlightedPoint)
          return (
            (d = c ? this.series && this.series[0] : d),
            (f = c ? d && d.points && d.points[0] : f) ? f.highlight() : !1
          );
        d = this.series[b.series.index + (c ? -1 : 1)];
        if (!d) return !1;
        f = a(b, d, 4);
        if (!f) return !1;
        if (g(d))
          return f.highlight(), (c = this.highlightAdjacentSeries(c)), c ? c : (b.highlight(), !1);
        f.highlight();
      ...
      n(f.prototype, {
              ...
              [
                ...
                function (a, c) {
                  if ((a = b.highlightedPoint))
                    (c.point = a), w(a.series, 'click', c), a.firePointEvent('click');
        ...
        onHandlerInit: function (a, c) {
          ...
          if (0 < c) d(b);
            ...
            for (
              var f;
              c-- &&
              !((b.highlightedPoint = b.series[c].points[b.series[c].points.length - 1]),
        ...
        onSeriesDestroy: function (a) {
          ...
          c.highlightedPoint &&
            ...
            (delete c.highlightedPoint, c.focusElement && c.focusElement.removeFocusBorder());
        },
        destroy: function () {
          this.eventProvider.removeAddedEvents();
        },
  ...
  v(
    ...
    function (b) {
      ...
      function q(b) {
        return (
          (b.options && b.options.accessibility && b.options.accessibility.description) ||
          ...
          g = b.points
            ...
            .map(function (a) {
              var c =
                ...
                (a.graphic && a.graphic.element && a.graphic.element.getAttribute('aria-label')) ||
                '';
              a = (a && a.series.name) || '';
      ...
      return {
        getAnnotationsInfoHTML: function (b) {
          var k = b.annotations;
          return k && k.length
            ? '<ul style="list-style-type: none">' + r(b).join(' ') + '</ul>'
            : '';
        },
  ...
  v(
    ...
    function (b, e, q, n, r) {
      function x(a) {
        var c = a.index;
        return a.series && a.series.data && H(c)
          ? h(a.series.data, function (a) {
              return !!(
                a &&
      ...
      function p(a, c) {
        ...
        return A(c)
          ? B(
              c,
              h.valueDecimals || a.valueDecimals || -1,
              b.decimalPoint,
              b.accessibility.thousandsSep || b.thousandsSep
            )
          : c;
      }
      function g(a) {
      ...
      function a(a) {
        var c = a.series,
          b = c.chart,
          h = b.options.accessibility.point || {};
        if ((c = c.xAxis && c.xAxis.dateTime))
          return (
            (c = c.getXDateFormat(a.x || 0, b.options.tooltip.dateTimeLabelFormats)),
            (h = (h.dateFormatter && h.dateFormatter(a)) || h.dateFormat || c),
            b.time.dateFormat(h, a.x || 0, void 0)
          );
      }
      function d(c) {
        var b = a(c),
          h =
            (c.series.xAxis || {}).categories &&
            H(c.category) &&
      ...
      function y(a) {
        ...
        return a.isNull
          ? c.chart.langFormat('accessibility.series.nullPointValue', { point: a })
          : c.pointArrayMap
          ? f(a, d, b)
          : d + h + b;
      }
      function G(a) {
        var c = a.series,
          ...
          f = (c = J(
            c.xAxis && c.xAxis.options.accessibility && c.xAxis.options.accessibility.enabled,
            !b.angular
          ))
            ? d(a)
            : '';
        ...
        (c || b) &&
          a.points.forEach(function (a) {
            ...
            if (
              ...
              ((b = a.series && a.series.is('sunburst')), (b = a.isNull && !b))
            ) {
              var h = a.series,
                d = x(a);
              h = (b = d && d.graphic) ? b.parentGroup : h.graph || h.group;
              d = d
                ? { x: J(a.plotX, d.plotX, 0), y: J(a.plotY, d.plotY, 0) }
                : { x: J(a.plotX, 0), y: J(a.plotY, 0) };
              ...
              h && h.element
                ? ((a.graphic = d),
                  (a.hasDummyGraphic = !0),
                  d.add(h),
                  h.element.insertBefore(d.element, b ? b.element : null),
                  (b = d.element))
                : (b = void 0);
            }
            ...
            b &&
              ...
              c && !h
                ? ((d = a.series),
                  (h = d.chart.options.accessibility.point || {}),
                  (d = d.options.accessibility || {}),
                  (a = F(
                    (d.pointDescriptionFormatter && d.pointDescriptionFormatter(a)) ||
                      (h.descriptionFormatter && h.descriptionFormatter(a)) ||
                      C(a)
                  )),
      ...
      function v(a) {
        ...
        return (
          (b.langFormat('accessibility.series.summary.' + a.type + h, k) ||
            b.langFormat('accessibility.series.summary.default' + h, k)) +
          (d ? ' ' + d : '') +
          (f('yAxis') ? ' ' + H : '') +
          (f('xAxis') ? ' ' + A : '')
        );
      ...
      return {
        describeSeries: function (a) {
          ...
          if (h) {
            ...
            (c.options3d && c.options3d.enabled && b) || !(b || d || f || m(a))
              ? h.setAttribute('aria-label', '')
              : ((c = a.chart.options.accessibility),
                (b = c.landmarkVerbosity),
                (a.options.accessibility || {}).exposeAsGroupOnly
                  ? h.setAttribute('role', 'img')
                  : 'all' === b && h.setAttribute('role', 'region'),
                h.setAttribute('tabindex', '-1'),
                (h.style.outline = '0'),
                h.setAttribute(
                  'aria-label',
                  F((c.series.descriptionFormatter && c.series.descriptionFormatter(a)) || v(a))
                ));
          }
        },
    ...
    function (b, e, q, n, r, x, m) {
      ...
      p(q.prototype, {
        ...
        addEventListeners: function () {
          ...
          b.addEvent(e, 'updatedData', function () {
        ...
        onSeriesUpdatedData: function (a) {
          ...
          a.chart === c &&
            ...
            ((this.dirty.hasDirty = !0), (this.dirty.allSeries[a.name + a.index] = a));
        },
        ...
        queueAnnouncement: function (a, c, b) {
          ...
          if (f.enabled) {
            ...
            if ((c = this.buildAnnouncementMessage(a, c, b)))
              this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer),
                (this.queuedAnnouncement = { time: g, message: c, series: a }),
        ...
        buildAnnouncementMessage: function (f, g, k) {
          ...
          if (l.announcementFormatter && ((f = l.announcementFormatter(f, g, k)), !1 !== f))
            return f.length ? f : null;
          f = b.charts && 1 < b.charts.length ? 'Multiple' : 'Single';
          f = g ? 'newSeriesAnnounce' + f : k ? 'newPointAnnounce' + f : 'newDataAnnounce';
          l = c(p);
          return p.langFormat('accessibility.announceNewData.' + f, {
            chartTitle: l,
  ...
  v(
    ...
    function (b, e) {
      function q(b) {
        r(!0, b, { marker: { enabled: !0, states: { normal: { opacity: 0 } } } });
      }
      var n = e.addEvent,
        r = e.merge;
      return function () {
        n(b, 'render', function () {
          ...
          if ((e = this.chart.options.accessibility.enabled && e))
            (e = this.chart.options.accessibility),
              (e =
                this.points.length < e.series.pointDescriptionEnabledThreshold ||
                    ...
                    ? (r(!0, l.marker, {
                        states: {
                          normal: {
                            opacity:
                              (l.marker.states &&
                                l.marker.states.normal &&
                                l.marker.states.normal.opacity) ||
                              1,
                          },
                        },
                      }),
                      (e.hasForcedA11yMarker = !1))
                    : (q(l), (e.hasForcedA11yMarker = !0)));
              }
          } else this.a11yMarkersForced && (delete this.a11yMarkersForced, (b = this.resetA11yMarkerOptions) && r(!0, this.options, { marker: { enabled: b.enabled, states: { normal: { opacity: b.states && b.states.normal && b.states.normal.opacity } } } }));
        });
        ...
        n(b, 'afterRender', function () {
          if (this.chart.styledMode) {
            if (this.markerGroup)
              this.markerGroup[this.a11yMarkersForced ? 'addClass' : 'removeClass'](
            ...
            this._hasPointMarkers &&
              ...
              this.points.forEach(function (b) {
                b.graphic &&
                  (b.graphic[b.hasForcedA11yMarker ? 'addClass' : 'removeClass'](
                    'highcharts-a11y-marker-hidden'
                  ),
                  b.graphic[!1 === b.hasForcedA11yMarker ? 'addClass' : 'removeClass'](
        ...
        hideSeriesLabelsFromATWhenShown: function () {
          this.addEvent(this.chart, 'afterDrawSeriesLabels', function () {
            this.series.forEach(function (c) {
              c.labelBySeries && c.labelBySeries.attr('aria-hidden', !0);
            });
          });
        },
        onChartRender: function () {
          this.chart.series.forEach(function (c) {
            !1 !== (c.options.accessibility && c.options.accessibility.enabled) && c.visible
              ? g(c)
              : p(c);
          });
        },
  ...
  v(
    ...
    function (b, e, q, n, r, x) {
      ...
      q.Axis.prototype.panStep = function (b, c) {
        ...
        0 > b && d < c.dataMin
          ? ((d = c.dataMin), (a = d + f))
          : 0 < b && a > c.dataMax && ((a = c.dataMax), (d = a - f));
      ...
      n(e.prototype, {
        ...
        onChartUpdate: function () {
          var b = this.chart,
            c = this;
          b.mapNavButtons &&
            b.mapNavButtons.forEach(function (a, d) {
              m(b, a.element);
        ...
        setMapNavButtonAttrs: function (b, c) {
          var a = this.chart;
          c = a.langFormat(c, { chart: a });
          k(b, { tabindex: -1, role: 'button', 'aria-label': c });
        },
        onChartRender: function () {
        ...
        recreateProxyButtonAndGroup: function (b, c, a, d) {
          ...
          this[c] = this.createProxyButton(b, this[a], { 'aria-label': d, tabindex: -1 });
        },
        getMapZoomNavigation: function () {
          ...
          return new r(c, {
            ...
            validate: function () {
              return !!(c.mapZoom && c.mapNavButtons && c.mapNavButtons.length);
            },
            init: function (b) {
        ...
        onMapKbdArrow: function (b, c) {
          var a = this.keyCodes;
          this.chart[c === a.up || c === a.down ? 'yAxis' : 'xAxis'][0].panStep(
            c === a.left || c === a.up ? -1 : 1
          );
        ...
        onMapKbdTab: function (b, c) {
          ...
          b = b.response;
          var d =
            ((c = c.shiftKey) && !this.focusedMapNavButtonIx) || (!c && this.focusedMapNavButtonIx);
              ...
              [
                ...
                function (a, b) {
                  return this.response[
                    (a === d.tab && b.shiftKey) || a === d.left || a === d.up ? 'prev' : 'next'
                  ];
                },
              ],
              [
        ...
        getKeyboardNavigation: function () {
          return [
            this.simpleButtonNavigation('resetZoomButton', 'resetZoomProxyButton', function (b, c) {
              c.zoomOut();
            }),
            this.simpleButtonNavigation('drillUpButton', 'drillUpProxyButton', function (b, c) {
              c.drillUp();
    ...
    function (b, e, q, n, r, x, m) {
      ...
      y(k, {
        rangeSelector: {
          ...
          inputStyle: { color: r.highlightColor80, cursor: 'pointer' },
          labelStyle: { color: r.neutralColor60 },
        },
      });
      y(k.lang, { rangeSelectorZoom: 'Zoom', rangeSelectorFrom: '', rangeSelectorTo: '\u2192' });
      var u = (function () {
        function e(a) {
          this.buttons = void 0;
        ...
        e.prototype.clickButton = function (c, d) {
          ...
          if (null !== e && null !== k) {
            ...
            u &&
              ...
              b.prototype.setDataGrouping.call(A || { chart: this.chart }, u, !1),
              (this.frozenStates = f.preserveDataGrouping));
            if ('month' === m || 'year' === m)
              if (A) {
                m = { range: f, max: l, chart: h, dataMin: e, dataMax: k };
              ...
              if (A)
                'undefined' === typeof k &&
                  ...
                  (d = !1)),
                  (l = this.getYTDExtremes(k, e, h.time.useUTC)),
                  (n = y = l.min),
                  (l = l.max);
              else {
            ...
            if (A)
              A.setExtremes(n, l, z(d, !0), void 0, {
        ...
        e.prototype.init = function (a) {
          ...
          this.eventsToUnbind.push(
            p(a, 'load', function () {
              a.xAxis &&
                a.xAxis[0] &&
                p(a.xAxis[0], 'setExtremes', function (c) {
        ...
        e.prototype.updateButtonStates = function () {
          ...
          a.buttonOptions.forEach(function (b, h) {
            ...
            e = e === f;
            ('month' === A || 'year' === A) &&
            f + 36e5 >= 864e5 * { month: 28, year: 365 }[A] * H - u &&
            f - 36e5 <= 864e5 * { month: 31, year: 366 }[A] * H + u
              ? (e = !0)
              : 'ytd' === A
              ? ((e = p - l + u === f), (q = !b))
              : 'all' === A && ((e = d.max - d.min >= t - k), (F = !b && n && e));
            A = !B && (O || r || F || g);
            H = (b && e) || (e && !n && !q) || (b && a.frozenStates);
            A ? (M = 3) : H && ((n = !0), (M = 2));
            J.state !== M &&
              (J.setState(M),
              c && ((c.options[h + 1].disabled = A), 2 === M && (c.selectedIndex = h + 1)),
              0 === M && m === h && a.setSelected());
          });
        };
          ...
          if (b) d += 'Z';
            ...
            if ((h = q.isSafari))
              (h = d),
                (h = !(
                  6 < h.length &&
                  (h.lastIndexOf('-') === h.length - 6 || h.lastIndexOf('+') === h.length - 6)
                ));
            h &&
        ...
        e.prototype.drawInput = function (a) {
          function b() {
            ...
            b !== Number(u.getAttribute('data-hc-time-previous')) &&
              ...
              n && g && w(f)
                ...
                : k &&
                  w(h) &&
                  (b < Number(k.getAttribute('data-hc-time')) ? (b = void 0) : b > h && (b = h)),
              'undefined' !== typeof b &&
                c.setExtremes(n ? b : c.min, n ? c.max : b, void 0, void 0, {
          ...
          B = p
            ...
            .attr({ padding: B ? 2 : 0, height: B ? m.inputBoxHeight : 0 })
            .add(f);
          p = p
            .label('', 0)
          ...
          d.styledMode || p.attr({ stroke: m.inputBoxBorderColor, 'stroke-width': 1 });
          p.add(f);
          var u = g('input', { name: a, className: 'highcharts-range-selector' }, void 0, h);
          u.setAttribute('type', l(m.inputDateFormat || '%b %e, %Y'));
          d.styledMode ||
            (B.css(v(t, m.labelStyle)),
            p.css(v({ color: r.neutralColor80 }, t, m.inputStyle)),
            c(
              u,
              y(
                {
          ...
          return { dateBox: p, input: u, label: B };
        };
        ...
        e.prototype.getYTDExtremes = function (a, b, c) {
          ...
          b = Math.max(b, c);
          h = h.getTime();
          return { max: Math.min(a || h, h), min: b };
        };
        e.prototype.render = function (b, c) {
          ...
          if (!1 !== k.enabled) {
            this.rendered ||
              ((this.group = h.g('range-selector-group').attr({ zIndex: 7 }).add()),
              (this.div = g('div', void 0, { position: 'relative', height: 0, zIndex: t })),
              this.buttonOptions.length && this.renderButtons(),
              f.parentNode && f.parentNode.insertBefore(this.div, f),
              e &&
                ((this.inputGroup = h.g('input-group').add(this.group)),
                (h = this.drawInput('min')),
                (this.minDateBox = h.dateBox),
                (this.minLabel = h.label),
                (this.minInput = h.input),
                (h = this.drawInput('max')),
                (this.maxDateBox = h.dateBox),
                (this.maxLabel = h.label),
                (this.maxInput = h.input)));
            if (
              e &&
        ...
        e.prototype.renderButtons = function () {
          ...
          this.chart.styledMode ||
            (this.zoomText.css(c.labelStyle), (e['stroke-width'] = z(e['stroke-width'], 0)));
        ...
        e.prototype.alignElements = function () {
          var a = this,
            ...
            p =
              t.exporting &&
              !1 !== t.exporting.enabled &&
              t.navigation &&
              t.navigation.buttonOptions;
          t = g.buttonPosition;
          var l = g.inputPosition,
            ...
            u = function (b, c) {
              return p &&
                ...
                'top' === m &&
                'right' === c.align &&
                c.y - b.getBBox().height - 12 < (p.y || 0) + (p.height || 0) + d.spacing[0]
                ? -40
                : 0;
            },
            n = d.plotLeft;
          if (f && t && l) {
            ...
            e &&
              ...
              'left' === l.align
                ? (B = n)
                : 'right' === l.align && (B = -Math.max(d.axisOffset[1], -b)),
              e.align(
                { y: l.y, width: e.getBBox().width, align: l.align, x: l.x + B - 2 },
                !0,
                d.spacingBox
              ),
              (e.placed = d.hasLoaded));
            this.handleCollision(b);
            f.align({ verticalAlign: m }, !0, d.spacingBox);
            ...
            'bottom' === m &&
              ((u =
                ...
                u.enabled &&
                !u.floating
                  ? d.legend.legendHeight + z(u.margin, 10)
                  : 0),
              (b = b + u - 20),
              (u = e - b - (g.floating ? 0 : g.y) - (d.titleOffset ? d.titleOffset[2] : 0) - 10));
            if ('top' === m)
              g.floating && (u = 0),
            ...
            g.inputEnabled &&
              t &&
              l &&
              ((t.style.marginTop = f.translateY + 'px'),
        ...
        e.prototype.alignButtonGroup = function (a, b) {
          ...
          d &&
            d.align(
              { y: h.y, width: z(b, this.initialButtonGroupWidth), align: h.align, x: e },
              !0,
              c.spacingBox
            );
        };
        e.prototype.positionButtons = function () {
          ...
          d &&
            'hidden' !== d.visibility &&
            (d[f]({ x: z(g + e.x, g) }), (k += e.x + d.getBBox().width + 5));
          this.buttonOptions.forEach(function (b, d) {
            if ('hidden' !== a[d].visibility)
              a[d][f]({ x: k }), (k += a[d].width + c.buttonSpacing);
            else a[d][f]({ x: g });
          });
        };
        e.prototype.handleCollision = function (a) {
          ...
          var t = function (b) {
              if (h && d) {
                var c = h.alignAttr.translateX + h.alignOptions.x - a + h.getBBox().x + 2,
          ...
          h && d
            ? k.align === e.align || t(this.initialButtonGroupWidth + 20)
              ? 'responsive' === g
                ? (this.collapseButtons(a), t(f()) && l())
                : l()
          ...
          var b = this.buttons,
            ...
            k = function (a) {
              return {
                ...
                paddingRight: z(f.buttonTheme.paddingRight, g.padding, 8),
              };
            };
          e && e.hide();
          var t = !1;
        ...
        e.prototype.hideDropdown = function () {
          var a = this.dropdown;
          a &&
            (c(a, { top: '-9999em', width: '1px', height: '1px' }), (this.hasVisibleDropdown = !1));
        };
        ...
        e.prototype.destroy = function () {
          ...
          I(
            ...
            function (b, c) {
              b &&
                'chart' !== c &&
                (b instanceof x ? b.destroy() : b instanceof window.HTMLElement && f(b));
      ...
      if (!q.RangeSelector) {
            ...
            function b() {
              d &&
                ...
                f.display &&
                  ...
                  ((e = v(a.spacingBox)),
                  (e.y = 'vertical' === f.options.layout ? a.plotTop : e.y + d.getHeight()),
                  (f.group.placed = !1),
                  f.align(e)));
            }
            var c,
        ...
        p(e, 'update', function (b) {
          ...
          c &&
            ...
            !a(b) &&
            this.options.rangeSelector &&
            ((this.options.rangeSelector.enabled = !0), (this.rangeSelector = b = new u(this)));
          this.extraTopMargin = this.extraBottomMargin = !1;
          b &&
            (K(this),
            (c = (c && c.verticalAlign) || (b.options && b.options.verticalAlign)),
            b.options.floating ||
              ('bottom' === c
                ? (this.extraBottomMargin = !0)
    ...
    function (b, e, q, n, r, x, m, l) {
      ...
      n.prototype.highlightRangeSelectorButton = function (a) {
        ...
        return b[a]
          ? (this.setFocusToElement(b[a].box, b[a].element),
            a !== e && ((this.oldRangeSelectorItemState = b[a].state), b[a].setState(1)),
            !0)
          : !1;
      };
      ...
      e(n.prototype, {
                ...
                if ((d = c[d]))
                  k(a, d),
                    b.setRangeInputAttrs(
                      d,
                      'accessibility.rangeSelector.' + (f ? 'max' : 'min') + 'InputLabel'
                    );
              }));
        },
        ...
        onButtonNavKbdArrowKey: function (a, b) {
          ...
          return e.highlightRangeSelectorButton(e.highlightedRangeSelectorItemIx + b)
            ? c.success
            : g
            ? (a.init(b), c.success)
            : c[0 < b ? 'next' : 'prev'];
        ...
        onButtonNavKbdClick: function (a) {
          ...
          3 !== b.oldRangeSelectorItemState &&
            this.fakeClickEvent(b.rangeSelector.buttons[b.highlightedRangeSelectorItemIx].element);
          return a.success;
        },
          ...
          if (p && a && l) {
            ...
            g = function (a) {
              (a.which || a.keyCode) === b.keyCodes.tab &&
                (a.preventDefault(), a.stopPropagation(), e.onInputKbdMove(a.shiftKey ? -1 : 1));
            };
            var m = c(a, 'keydown', g),
              n = c(l, 'keydown', g);
        ...
        initDropdownNav: function () {
          ...
          e &&
            g &&
            (b.setFocusToElement(e.buttonGroup, g),
            this.removeDropdownKeydownHandler && this.removeDropdownKeydownHandler(),
            (this.removeDropdownKeydownHandler = c(g, 'keydown', function (c) {
              (c.which || c.keyCode) === a.keyCodes.tab &&
                (c.preventDefault(),
                c.stopPropagation(),
                b.accessibility &&
                  (b.accessibility.keyboardNavigation.tabindexContainer.focus(),
                  b.accessibility.keyboardNavigation[c.shiftKey ? 'prev' : 'next']()));
            })));
        },
          ...
          return new x(a, {
            ...
            validate: function () {
              return !!(
                ...
                'hidden' !== a.rangeSelector.inputGroup.element.getAttribute('visibility') &&
    ...
    function (b, e, q, n, r, x, m, l, k, p) {
      ...
      e.prototype.getTypeDescription = function (a) {
        ...
        if (1 < this.types.length)
          return this.langFormat('accessibility.chartTypes.combinationChart', c);
        a = a[0];
        ...
        return (
          (this.langFormat('accessibility.chartTypes.' + a + d, c) ||
            this.langFormat('accessibility.chartTypes.default' + d, c)) + (b ? ' ' + b : '')
        );
      };
      e = function () {};
      e.prototype = new x();
      q(e.prototype, {
        ...
        setScreenReaderSectionAttribs: function (a, b) {
          ...
          D(a, { id: 'highcharts-screen-reader-region-' + b + '-' + c.index, 'aria-label': d });
        ...
        defaultBeforeChartFormatter: function () {
          var a = this.chart,
            ...
            g = d(a),
            k = a.langFormat('accessibility.screenReaderSection.annotations.heading', { chart: a });
          c = {
        ...
        getTypeDescriptionText: function () {
          var a = this.chart;
          return a.types
            ? a.options.accessibility.typeDescription || a.getTypeDescription(a.types)
            : '';
        },
            ...
            (c.onclick = function (a) {
              (
                (d.options.accessibility &&
                  d.options.accessibility.screenReaderSection.onPlayAsSoundClick) ||
                e
              ).call(this, a, d);
            }));
        },
        initDataTableButton: function (a) {
          ...
          b &&
            (D(b, { tabindex: -1, 'aria-expanded': !!N(a) }),
            (b.onclick =
              c.options.accessibility.screenReaderSection.onViewDataTableClick ||
              function () {
                c.viewData();
              }));
        },
        getAxesDescription: function () {
          var b = this.chart,
            c = function (c, d) {
              ...
              return (
                1 < c.length ||
                (c[0] && a(c[0].options.accessibility && c[0].options.accessibility.enabled, d))
              );
            },
        ...
        getAxisDescriptionText: function (a) {
          var b = this.chart,
            c = b[a];
          return b.langFormat(
            'accessibility.axis.' + a + 'Description' + (1 < c.length ? 'Plural' : 'Singular'),
            {
              chart: b,
      ...
      q(n.prototype, {
        ...
        handleSVGTitleElement: function () {
          var b = this.chart,
            ...
            a = p(b.langFormat('accessibility.svgContainerTitle', { chartTitle: l(b) }));
          if (a.length) {
            var d = (this.svgTitleElement =
              this.svgTitleElement || k.createElementNS('http://www.w3.org/2000/svg', 'title'));
            d.textContent = a;
            d.id = c;
        ...
        setSVGContainerLabel: function () {
          var b = this.chart,
            c = b.langFormat('accessibility.svgContainerLabel', { chartTitle: l(b) });
          b.renderer.box && c.length && b.renderer.box.setAttribute('aria-label', c);
        },
        setGraphicContainerAttrs: function () {
          var b = this.chart,
            c = b.langFormat('accessibility.graphicContainerLabel', { chartTitle: l(b) });
        ...
        setRenderToAttrs: function () {
          ...
          b.renderTo.setAttribute(
            'aria-label',
            b.langFormat('accessibility.chartContainerLabel', { title: l(b), chart: b })
          );
        },
          ...
          c &&
            (c.textStr &&
              c.element.setAttribute(
                'aria-label',
                b.langFormat('accessibility.credits', { creditsStr: p(c.textStr) })
              ),
            m(b, c.element));
        },
        getKeyboardNavigation: function () {
        ...
        b.series.forEach(function (b) {
          ...
          b.points.forEach(function (b) {
            b.options &&
              b.options.color &&
              b.update(
                { color: l.color || 'windowText', borderColor: l.borderColor || 'window' },
                !1
              );
          });
        });
      ...
      accessibility: {
        ...
        keyboardNavigation: {
          ...
          focusBorder: {
            ...
            style: { color: b.highlightColor80, lineWidth: 2, borderRadius: 3 },
            margin: 2,
          },
      ...
      Object.keys(c).forEach(function (a) {
        ...
        'undefined' !== typeof p &&
          ...
          m(
            ...
            !1,
            b,
            ((k = {}), (k[l.join('.') + '.' + a] = g.join('.') + '.' + c[a].join('.')), k)
          ));
      });
    }
    function n(b) {
      ...
      ['description', 'typeDescription'].forEach(function (c) {
        ...
        e[c] &&
          ((g[c] = e[c]),
          m(32, !1, b, ((a = {}), (a['chart.' + c] = 'use accessibility.' + c), a)));
      });
    }
    function r(b) {
      b.axes.forEach(function (e) {
        (e = e.options) &&
          ...
          m(32, !1, b, { 'axis.description': 'use axis.accessibility.description' }));
      });
    }
    function w(b) {
      var k = {
      ...
      b.series.forEach(function (g) {
        Object.keys(k).forEach(function (c) {
          var a,
            d = g.options[c];
          'undefined' !== typeof d &&
            (e(g.options, k[c], 'skipKeyboardNavigation' === c ? !d : d),
            m(32, !1, b, ((a = {}), (a['series.' + c] = 'series.' + k[c].join('.')), a)));
        });
      });
    }
    var m = b.error,
    ...
    function (b, e, q, n) {
      function r(b, e) {
        ...
        if (-1 < k) {
          ...
          if ((e = e[a[0]]))
            for (
              k = isNaN(k) ? e.length : k, k = 0 > k ? e.length + k : Math.min(k, e.length), a = 0;
              a < k;
              ++a
            )
              b += g + e[a] + c;
        ...
        return -1 < c
          ? ((g = b.substring(0, c)),
            (c = Number(b.substring(c + 1, a))),
            (b = void 0),
            (e = e[g]),
            !isNaN(c) &&
              e &&
              (0 > c
                ? ((b = e[e.length + c]), 'undefined' === typeof b && (b = e[0]))
                : ((b = e[c]), 'undefined' === typeof b && (b = e[e.length - 1]))),
      ...
      e.i18nFormat = function (b, e, m) {
        var g = function (a, b) {
            ...
            var c = a.indexOf('{'),
              d = a.indexOf('}');
            if (-1 < c && d > c)
              return { statement: a.substring(c + 1, d), begin: b + c + 1, end: b + d };
          },
          c = [],
          a = 0;
        do {
          ...
          f.length && c.push({ value: f, type: 'constant' });
          d && c.push({ value: d.statement, type: 'statement' });
          a = d ? d.end + 1 : a + 1;
        } while (d);
        c.forEach(function (a) {
  ...
  v(
    ...
    function (b, e, q, n) {
      ...
      k(e.prototype, {
        addFocusBorder: function (b, a) {
          ...
          if ('text' === this.element.nodeName || n) {
            ...
            n &&
              ...
              (l = m),
              (m = n),
              isNaN(z) || (g = z - c.height * x.x - e),
              isNaN(E) || (k = E - c.width * x.y - e));
          }
          this.focusBorder = this.renderer
            .rect(g, k, l, m, parseInt(((a && a.r) || 0).toString(), 10))
            .addClass('highcharts-focus-border')
            .attr({ zIndex: 99 })
            .add(this.parentGroup);
          this.renderer.styledMode ||
            this.focusBorder.attr({ stroke: a && a.stroke, 'stroke-width': a && a.strokeWidth });
          w(this, b, a);
          r(this);
        },
        removeFocusBorder: function () {
          ...
          this.focusBorderDestroyHook &&
            ((this.destroy = this.focusBorderDestroyHook), delete this.focusBorderDestroyHook);
      ...
      b.prototype.setFocusToElement = function (b, a) {
        ...
        (a = a || b.element) &&
          a.focus &&
          ((a.hcEvents && a.hcEvents.focusin) || l(a, 'focusin', function () {}),
          a.focus(),
          c.hideBrowserFocusOutline && (a.style.outline = 'none'));
        this.focusElement && this.focusElement.removeFocusBorder();
        this.focusElement = b;
  ...
  v(
    ...
    function (b, e, q, n, r, v, m, l, k, p, g, c, a, d, f, y, G, C, L, N, I, D, z) {
      ...
      var t = q.doc,
        ...
        K = l.fireEvent,
        F = l.merge;
      F(!0, r.defaultOptions, N, { accessibility: { highContrastTheme: L }, lang: I });
      ...
      w.prototype = {
        init: function (a) {
          this.chart = a;
          t.addEventListener && a.renderer.isSVG
            ? (D(a),
              this.initComponents(),
              (this.keyboardNavigation = new p(a, this.components)),
              this.update())
